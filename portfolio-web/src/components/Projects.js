...
function Projects() {
  return (
    <>
      <div className="text-white m-2 sm:m-4 lg:m-6 lg:mb-6 z-10">
        <div className="neumorphic rounded-lg p-4 h-full flex flex-col">
          ...
          <div>
            <div className="text-lg sm:text-xl lg:text-2xl my-2 mt-4">
              <span className="text-green-dark hover:text-wa-green transition-all duration-500 ease-in-out">
                My Works
              </span>
            </div>
            <div className='px-4 py-0 sm:py-4 flex flex-wrap flex-row justify-around'>
              {
                project.map((e) => {
