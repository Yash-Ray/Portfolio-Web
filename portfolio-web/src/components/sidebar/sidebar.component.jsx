...
export const Sidebar = () => (
  <div className="sidebar-left text-light-sub p-20 pt-60 flex flex-col justify-between items-start">
    <div className="w-full">
      <Link to='/'><div className="element-sidebar w-4/5 p-2 px-4 sm:p-4 my-6 mx-auto flex flex-row items-center text-base sm:text-lg">
        <FaHome className="mr-2" /> HOME
      </div></Link>
      <Link to='/projects'><div className="element-sidebar w-4/5 p-2 px-4 sm:p-4 my-6 mx-auto flex flex-row items-center text-base sm:text-lg">
    ...
    <div className="w-full">
      <a target="_blank" rel='noreferrer' href="https://github.com/Yash-Ray/Portfolio-Web">
